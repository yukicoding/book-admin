      ...
      <el-header style="font-size: 12px; background-color: #545c64 ;height: 90px">
        ...
        <div id="app">
          <el-menu :default-active="activeIndex2" class="el-menu-demo" mode="horizontal" @select="handleSelect"
            ...
            <span
              style="font-family: 华文行楷;float: left;font-size: 50px;margin-top: 30px;text-shadow: 0 0 7px #fff">奇缘书库</span>
            ...
            <!--<template slot="title">事务处理</template>-->
            <!--<el-menu-item index="2-1">查询作品</el-menu-item>-->
            <!--<el-menu-item index="2-2">查询作家</el-menu-item>-->

            <!--</el-submenu>-->
            <!--</div>-->
            <!--<div style="float: right;margin-top: 30px">-->
            <!--<el-menu-item index="3" disabled style="font-family: 华文行楷;font-size: 20px">用户名:方蔚源</el-menu-item>-->
            <!--</div>-->
          </el-menu>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple-light" border-style="solid" style="margin-top: -13px">
                  ...
                  <el-card class="box-card" shadow="hover" style="margin:40px;border-radius: 20px;">
                    <div slot="header" class="clearfix a">
                      ...
                      <el-button type="text" @click="open(item.id)">
                        <h1>
                          <li class="el-icon-platform-eleme"></li>{{ item.name }}
                        </h1>
                      </el-button>
                      <!-- <el-button style="float: right; padding: 3px 0" type="text">操作按钮</el-button> -->
                    </div>
                    <div class="text item">
                      <p>江南第一才子唐寅行书《诗笺》书法图片10张唐寅（1470-1523）字伯虎，更字子畏，号桃花庵主，
                        鲁国唐生，逃禅仙史，南京解元，江南第一风流才子等。“明四大家”之一，被誉为明中叶江南第一才子。他博学多能，
                        吟诗作曲，能书善画，经历坎坷。是我国绘画史上杰出的大画家。唐寅书法为画名所掩...</p>
                    </div>
                    <div class="bottom clearfix">
              ...
              <!-- <div class="b" style="height: 200px">
                <h1 align="center">
                  <li class="el-icon-platform-eleme"></li>
                  黄庭坚行楷书法《梨花诗》&nbsp;&nbsp;&nbsp;&nbsp;
                </h1>
                <p>黄庭坚行楷书法《梨花诗》碑帖拓本，29X272cm。原诗共20首诗，本帖缺失。《秦邮帖》为钱泳在嘉庆二十年为师亮采刻，
                  《黄庭坚梨花诗并序》为其中一帖，属伪刻。（水赉佑《黄庭坚伪迹考叙》） 梨花诗，外甥孙莘老以梨花唱和诗寄余索和，
                  夫诗生于情，不情而何以诗？余自黔还戎多日，苦思情由... </p>
                <p align="right"> 2021-10-25 9:31:45</p>
                <el-divider></el-divider>
              </div>
              <div class="b" style="height: 200px">
                <h1 align="center">
                ...
                <p>王羲之行书欣赏《日月如驰帖》(大图)，五行，35字。又称《日月帖》。
                  褚遂良《右军书目》行书第十卷记载此帖首七字，并称“五行”，与此帖相合。《右军书记》亦著录此帖。
                  《宝晋斋帖》、《大观帖》、《玉烟堂帖》收刻。此帖继《奄至帖》之後，书体风格一致，亦似墨迹本《频有哀祸帖》、《丧乱帖》。...
                </p>
                <p align="right"> 2021-10-19 11:06:38</p>
                <el-divider></el-divider>
              </div>
              <div class="b" style="height: 200px">
                <h1 align="center">
                ...
                <p>江南第一才子唐寅行书《诗笺》书法图片10张唐寅（1470-1523）字伯虎，更字子畏，号桃花庵主，
                  鲁国唐生，逃禅仙史，南京解元，江南第一风流才子等。“明四大家”之一，被誉为明中叶江南第一才子。他博学多能，
                  吟诗作曲，能书善画，经历坎坷。是我国绘画史上杰出的大画家。 </p>
                <p align="right"> 2021-10-17 17:37:49</p>
                <el-divider></el-divider>
              </div> -->
